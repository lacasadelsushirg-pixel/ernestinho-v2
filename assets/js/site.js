...
function ensureTools() {
  ...
  if(!tools){
    const back=document.querySelector("nav.back a.back, nav.back, a.back, .back");
    const main=document.querySelector("main");
    const host=back?.parentElement||document.querySelector("header")||main||document.body;
    tools=document.createElement("div");
    tools.className="tools ec-language-tools ec-floating-language-tools";
    tools.setAttribute("role","group");
    tools.setAttribute("aria-label","Cambiar idioma");
    if(back&&back.parentElement)back.insertAdjacentElement("afterend",tools);
    else if(main)main.insertBefore(tools,main.firstChild);
