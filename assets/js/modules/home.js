...
const card = (item, cls, group) => {
  ...
  if (cls === 'door') return '<a class="door" href="' + route + '" data-route="' + route + '">' + cover + '<span class="door-copy"><b data-i18n="' + group + '.' + id + '.title">' + title + '</b><span class="card-copy" data-i18n="' + group + '.' + id + '.copy">' + copy + '</span><small data-i18n="home.explore">EXPLORAR →</small></span></a>';
